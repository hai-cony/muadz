...
export default function Kabupaten({ auth, tahun }) {
    ...
    const [kabId, setKabId] = useState(0);
    ...
    const submit = (e) => {
        e.preventDefault();
        if (thn == 0 || thn == "Pilih Tahun")
            return setError({ thnRequire: "Tentukan tahun terlebih dahulu!" });
        router.post("/kelola-database/kabupaten", {
            newKab: newKab,
            thn: thn,
        });
        setTambah(false);
    ...
    const del = () => {
        router.post(route("kelola-database-hapus-kabupaten"), { id: kabId });
        setConfirm(false);
    };
    return (
        <>
            ...
            <div className="max-w-6xl mt-10 mx-auto shadow-md">
                ...
                <div className="flex mt-10 justify-between">
                    <div className="ml-5 font-semibold">Kabupaten</div>
                        ...
                        <div className="relative bg-gray-200 rounded-lg shadow">
                            ...
                            <div className="px-6 py-6 lg:px-8">
                                <h3 className="mb-4 text-xl px-5 text-center font-medium text-gray-900">
                                    Hapus Kabupaten {kabName} Tahun {thn}?
                                </h3>
